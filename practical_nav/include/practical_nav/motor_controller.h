...
public:
    ...
    void setMotorsDirection(int leftPwmOut, int rightPwmOut, DifferentialDriveRobot& robot);
    void bumpStart(int leftPwmOut, int rightPwmOut, DifferentialDriveRobot& robot);
    void incrementPwm(int& leftPwmOut, int& rightPwmOut, DifferentialDriveRobot& robot);
    void capPwmOutputs(int& leftPwmOut, int& rightPwmOut, DifferentialDriveRobot& robot);

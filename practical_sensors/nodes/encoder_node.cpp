...
int main(int argc, char **argv) {
  ...
  Encoder rightEncoder(nh, pi, PinAssignments::rightEncoder, PinAssignments::rightReverse, "rightWheel");

  //leftEncoder.callbackId_ = callback(pi, leftEncoder.encoderPin_, EITHER_EDGE, &Encoder::staticEventCallback, &leftEncoder);
  //rightEncoder.callbackId_ = callback(pi, rightEncoder.encoderPin_, EITHER_EDGE, &Encoder::staticEventCallback, &rightEncoder);
